...
Name the application "KendoSchedulerAjaxEditing". If you decided not to use the UI for ASP.NET MVC Visual Studio Extensions follow the steps from the [introduction](/getting-started/using-kendo-with/aspnet-mvc/introduction) help topic in order
