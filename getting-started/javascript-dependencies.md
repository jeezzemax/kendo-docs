...
> **Important**: kendo.all.min.js is available in the Kendo UI Complete, **UI for ASP.NET MVC**, **Telerik UI for JSP** and **Telerik UI for PHP** distributions. The contents of
